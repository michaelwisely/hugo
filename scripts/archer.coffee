...
#   rrix
#
# Adapted from [this](https://github.com/github/hubot-scripts/blob/master/src/scripts/archer.coffee) script.
...
module.exports = (robot) ->
  ...
  robot.hear /archer/i, (msg) ->
    ...
    request options, (err, response, body) ->
      ...
      jsdom.env
        html: body
        scripts: ['https://code.jquery.com/jquery-1.11.1.min.js']
        done: (err, window) ->
          throw err if err
